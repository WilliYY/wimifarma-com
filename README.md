...
- Em 2026-06-03, a Home autenticada informa ao widget global o nome exibido do usuario logado, vindo de `core_users.display_name` quando disponivel, para mostrar falas curtas perto do botao flutuante do Miauby apenas na Home. O controle fica em `sessionStorage` por usuario/sessao, a primeira fala aparece alguns segundos depois da entrada e as proximas sao agendadas entre 45 e 120 segundos, com lista ampla de frases rotativas, sem repetir a ultima por usuario, usando primeiro nome quando o nome exibido e longo, pausando por alguns minutos quando a pessoa interage com o widget e cache-bust `20260603-home-speech-v2`; nao houve mudanca em login, SSO, chat, audio, permissao ou backend do Miauby.
