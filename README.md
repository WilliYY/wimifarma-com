...
- Desde 2026-08-16, o WhatsApp completa pedidos de relatorio em varias mensagens: `miauby relatorio`, o tipo e a data podem chegar separados. O bridge guarda somente o estado sanitizado por hash do telefone por 15 minutos, aceita a resposta esperada sem prefixo, rejeita datas impossiveis e encerra por consumo, cancelamento ou expiracao. Datas exatas usam `America/Sao_Paulo`; Financeiro consulta o endpoint diario, enquanto Cashback e Tarefas recebem intervalo de um dia, sem apresentar resumo mensal como se fosse diario.
