...
- Desde 2026-08-22, Miauby Interno e Miauby WhatsApp registram produtos no Falteiro da Cotacao por intencao natural de falta, estoque baixo, compra ou reposicao, sem depender de ordem, caixa ou sintaxe fixa. Uma mensagem pode conter ate 50 itens separados por virgula, ponto e virgula ou quebra de linha; a intencao e herdada, mas produto e categoria sao interpretados por item. `Produto` preserva identidade, dosagem, apresentacao, embalagem e marca obrigatoria; `Categoria` combina o rotulo oficial mais especifico com estoque, quantidade de compra, prazo, preco, preferencia, demanda e observacao. Negacao da acao bloqueia, restricao negativa e preservada, demanda geral vai ao Falteiro e reserva individual segue para Encomenda. A gravacao reserva todas as primeiras linhas vazias numa unica transacao e nao conclui parcialmente; acima do limite, nenhum item e gravado.
