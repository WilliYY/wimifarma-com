...
- Desde 2026-06-08, a Home usa `logo-wimifarma-home-animated.svg` como variacao animada sem fundo da marca, aplicada no login central, no rodape do login e no header autenticado; o asset versionado remove a camada branca do SVG fornecido, usa `mix-blend-mode: multiply` e microanimacao CSS no elemento para evitar retangulo branco e manter movimento legivel no ciclo mobile/desktop, com cache-bust em `site/home.php`.
