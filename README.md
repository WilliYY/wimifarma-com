...
- Desde 2026-08-16, Miauby Interno e WhatsApp tambem criam Encomenda por linguagem natural em qualquer ordem, separando produto/apresentacao de cliente, telefone e informacoes extras. Cliente e telefone sao opcionais; produto e confirmacao sao obrigatorios. A Cotacao revalida ator ativo/permissao e usa `source + request_id` para impedir duplicacao, sem substituir o cliente pelo usuario que executou. Consultas de encomendas continuam somente leitura.
