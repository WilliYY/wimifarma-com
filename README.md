...
- Desde 2026-08-24, perguntas simples de Encomenda, inclusive `quais encomenda tem?`, entram na leitura deterministica antes da interpretacao semantica. `sim`/`nao` sem confirmacao forte pendente continuam a conversa, sem executar escrita antiga. A memoria curta e o resumo persistente duram 24 horas renovaveis (`86400` segundos), enquanto a validade de uma acao pendente permanece em 5 minutos (`300` segundos).
