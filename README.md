...
- Desde 2026-06-05, `/login-senha/` mostra os acessos em tabela compacta tipo planilha, com colunas Nome, Login / Usuario, Senha mascarada e Status. Clicar na linha abre o painel de edicao do proprio acesso; revelar/copiar senha continua usando endpoint auditado e a senha nao e enviada no HTML inicial.
