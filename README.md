...
- Desde 2026-07-21, o card ADM `Wimi Impressora` disponibiliza um unico instalador Windows para o computador USB da Bematech MP-4200 TH. O agente instala servico com inicio automatico, pareia sem digitacao de codigo, recebe a fila central por HTTPS e atualiza sozinho com verificacao SHA-256. Os comprovantes continuam oferecendo a impressao local do navegador como fallback. Arquitetura, seguranca, build e operacao ficam em `docs/31-wimi-impressora.md`.
