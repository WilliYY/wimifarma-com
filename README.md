...
- O widget do Miauby voltou a carregar dentro da Cotacao V2, a tela de login foi compactada para ocupar menos a tela e o parser do widget tolera respostas JSON com ruido antes/depois do payload.
