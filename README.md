...
- Pendencias/cuidados atuais da Cotacao V2: Google Sheets ainda precisa de credenciais reais no `.env` do VPS; restore/import/delete de coluna sao acoes fortes e devem ganhar permissao por perfil antes de liberar geral; o `fill handle` visual existe, mas arrastar para preencher igual Sheets ainda pode evoluir.
