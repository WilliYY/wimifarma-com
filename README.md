...
- Em 2026-06-03, os cards do painel Usuarios foram refinados apenas no frontend: cabecalho, badges, edicao de conta, cofre ADM, status, modulos, ferias, tarefa privada e WhatsApp passam a usar grids responsivos mais previsiveis, mantendo os mesmos campos, CSRF, permissoes, senha/hash, cofre e endpoints.
