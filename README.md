...
- Desde 2026-06-07, os cards de clientes recentes/encontrados no Balcao do Cashback usam uma grade mais aberta com dados separados em ID, telefone, atendente, atualizado, saldo e acoes, para evitar texto espremido sem alterar busca, selecao, resgate ou historico.
- A tela `Mensagens` do Cashback mostra cards de WhatsApp pendentes com campanha, cliente, telefone/detalhe e acoes; abrir WhatsApp, copiar texto ou excluir atualiza o status salvo e remove o card da fila visual, sem apagar o historico.
