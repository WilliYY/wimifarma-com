...
- Desde 2026-05-27, o bridge WhatsApp pode transcrever audios autorizados com Gemini e responder em audio por Gemini TTS quando as flags de audio estiverem ligadas. `MIAUW_WHATSAPP_AUDIO_TTS_STYLE` ajusta a leitura para uma voz humana clara com leve jeito de gato/Miauby, sem clonagem de voz. O Git mantem audio desligado por padrao; o banco guarda metadados sanitizados e transcricao, nunca bytes de audio bruto.
