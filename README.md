...
- Desde 2026-06-09, a Home usa `logo-wimifarma-home-animated.svg` como variacao animada em loop enviada pelo usuario, sem fundo, aplicada no login central, no rodape do login e no header autenticado. O SVG mantem a animacao interna, carrega com preload `image/svg+xml`, prioridade/cache-bust em `site/home.php`, proporcao `1024/400` e sem `mix-blend-mode`.
