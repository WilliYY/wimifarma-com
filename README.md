...
- Desde 2026-06-06, o modal `Trocar usuario` destaca o usuario atual com cor propria, faixa lateral e badge `Atual`, sem mudar o fluxo de senha nem a renovacao de `WFHOME`/`WFHOME_SSO`.
