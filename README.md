...
- O modulo `site/codigos` guarda atalhos de comissao em `wf_codigos_comissao`, com duas tabelas por prefixo de EAN (`20` e `40`), autosave de `Código`, `EAN` e `Preço`, criacao de novas linhas no rodape de cada grupo e exclusao logica de itens apagados.
