...
- Desde 2026-06-08, a Home usa novamente `logo-wimifarma-home-animated.gif` como variacao animada sem fundo da marca, aplicada no login central, no rodape do login e no header autenticado; essa e a animacao original aprovada pelo usuario. A tentativa de recriar a animacao em SVG ficou fora do fluxo da Home, porque alterava o movimento visual. O GIF carrega com preload `image/gif`, prioridade/cache-bust em `site/home.php`, proporcao real `1560/622` e sem `mix-blend-mode`.
