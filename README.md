...
- Miauby tambem entende comandos controlados da Gestao: `gestao` aponta para `/gestao/`, e `gestao - titulo - 500 - categoria` prepara uma conta a pagar com confirmacao humana antes de gravar pelo endpoint interno tokenizado da Gestao.
