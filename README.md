...
- No editor de celula da Cotacao V2, duplo clique e `F2` entram em edicao sem selecionar todo o conteudo existente; o usuario consegue posicionar cursor, selecionar trechos e usar setas dentro do texto. O rodape `Adicionar 20 linhas` adiciona linhas no DOM de forma incremental para evitar lag em planilhas maiores.
