...
- Desde 2026-08-16, Miauby Interno e Miauby WhatsApp registram produtos no Falteiro da Cotacao por intencao natural de falta de estoque ou necessidade de compra, sem diferenciar maiusculas/minusculas. A Cotacao interpreta produto, apresentacao e categoria uma unica vez, ocupa atomicamente a primeira linha com `PRODUTO` vazio e usa somente categorias ja presentes na planilha ou nas regras da coluna `categoria`.
