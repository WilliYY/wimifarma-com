...
- Desde 2026-06-08, a Home usa `logo-wimifarma-home-animated.svg` como variacao animada sem fundo da marca, aplicada no login central, no rodape do login e no header autenticado; o asset versionado remove a camada branca do SVG fornecido e usa cache-bust em `site/home.php`.
