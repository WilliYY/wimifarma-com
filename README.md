...
- Desde 2026-07-21, o inicio do Balcao oferece `Cashback rapido`: valor gasto, previa do percentual padrao, atendente que imprime e emissao de codigo aleatorio de quatro digitos com validade de um ano. O codigo nao precisa de cliente na emissao, mas exige cadastro/selecao no uso; o primeiro uso pode ocorrer junto ao `Novo cliente`, e os seguintes usam `Gastar/Usar Cashback`. O resgate integral preserva a regra 4x e gera o proximo codigo sobre o valor cobrado depois do desconto. O recibo responsivo para rolo de 80 mm usa a logo oficial em PNG preparada em preto sobre branco e abre o dialogo da impressora do computador; a web nao seleciona silenciosamente a Bematech MP-4200 TH. Codigos nunca sao reutilizados, portanto o espaco de quatro digitos comporta 10.000 emissoes totais.
