...
- Desde 2026-06-08, a Home usa `logo-wimifarma-home-animated.svg` como variacao animada sem fundo da marca, aplicada no login central, no rodape do login e no header autenticado; o asset versionado preserva o loop infinito, remove a camada branca externa, usa recorte branco/transparente pre-processado em vez de filtro SVG em tempo real, inicia em um frame visivel para evitar engasgo de entrada e carrega com preload/prioridade/cache-bust em `site/home.php`, sem `mix-blend-mode`.
