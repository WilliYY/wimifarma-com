...
- Desde 2026-06-08, a Home usa `logo-wimifarma-home-animated.svg` como variacao animada sem fundo da marca, aplicada no login central, no rodape do login e no header autenticado; o asset versionado preserva os keyframes originais em loop infinito, remove apenas a camada branca do SVG fornecido e nao usa `mix-blend-mode` no CSS para nao escurecer a marca nos fundos coloridos, com cache-bust em `site/home.php`.
