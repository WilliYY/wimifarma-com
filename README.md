...
- A operacao diaria tambem cobre `Ctrl+C` em selecao de celulas, `Ctrl+Z` para desfazer filtros/busca local, colagem com normalizacao de texto/numeros, formato condicional que pinta apenas fundo com texto preto, manutencao da linha visivel durante edicao sob filtro e heartbeat/recarregamento leve apos inatividade.
