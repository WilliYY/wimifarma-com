...
- Em 2026-06-02, a Home autenticada passou a informar ao widget global o nome exibido do usuario logado, vindo de `core_users.display_name` quando disponivel, para mostrar uma saudacao curta perto do botao flutuante do Miauby apenas na primeira entrada da sessao da Home. O controle fica em `sessionStorage`, as frases rotacionam sem repetir a ultima, o cache-bust da Home e `20260602-home-greeting`, e nao houve mudanca em login, SSO, chat, audio, permissao ou backend do Miauby.
