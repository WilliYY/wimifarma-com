...
- Em `/cashback/relatorio.php`, a area de atendentes usa cards compactos em grade normal, sem rolagem interna, mantendo os mesmos formularios, CSRF, POSTs, exclusao/inativacao e exportacoes.
