...
- Desde 2026-06-11, a compra/resgate do Balcao e o registro simples de compra aceitam `Cashback Manual`; quando preenchido, ele substitui o novo cashback automatico para nao gerar dois beneficios na mesma compra. O detalhe do cliente mostra dias restantes por credito e permite excluir do saldo apenas cashback gerado ainda intacto, por cancelamento logico/auditoria. Cada uso real de cashback gera +500 XP para o usuario logado vinculado ao XP, com idempotencia por resgate e sem bloquear a compra se o XP estiver indisponivel.
