...
const textCommandContracts: TextCommandContract[] = [
  ...
  },
  {
    ...
    ambiguity_rules: [
      ...
      'mais de uma tarefa parecida pede escolha curta',
      'uma tarefa clara pede confirmacao antes de concluir',
    ],
    response_examples: ['Confirma concluir: "Trocar todos os distribuidores"?', 'Tarefa concluida: Trocar todos os distribuidores.'],
