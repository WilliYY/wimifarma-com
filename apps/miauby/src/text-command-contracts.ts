...
const textCommandContracts: TextCommandContract[] = [
  ...
  },
  {
    ...
    title: 'Listar pedidos aguardando chegada',
    module: 'pedidos',
    ...
    optional_fields: ['limite'],
    internal_examples: [
      'pedidos',
      'ver pedidos',
      'pedidos abertos',
      'o que falta chegar',
      'pedidos aguardando chegada',
    ],
    whatsapp_examples: [
      'miauby pedidos',
      'miauby ver pedidos',
      'miauby o que tem para chegar',
      'miauby pedidos aguardando chegada',
    ],
    missing_data_replies: ['Sessao expirada. Entre no sistema antes de consultar Pedidos.'],
    ambiguity_rules: [
      'listar somente pedidos em Aguardando chegada',
      'mostrar fornecedor, valor, data do pedido, previsao e status em uma linha',
      'sem pedido aberto, responder curto',
    ],
    response_examples: [
      'Pedidos aguardando chegada: ANB - R$ 350,00 - pedido em 02/06 - sem previsao.',
      'Nenhum pedido aguardando chegada. Milagre logistico detectado.',
    ],
    notes: [
      'consulta usa app Pedidos Node/Postgres por endpoint interno tokenizado',
      'nao lista historico/finalizados neste comando',
    ],
    keywords: ['pedido', 'pedidos', 'falta chegar', 'aguardando chegada', 'pendente'],
  },
  {
    intent: 'cancelar_pedido',
    title: 'Cancelar pedido aguardando chegada',
    module: 'pedidos',
    ...
    internal_supports_media: false,
    whatsapp_supports_media: false,
    required_fields: ['responsavel_identificado', 'texto_ou_id_do_pedido'],
    optional_fields: ['order_id', 'account_id'],
    internal_examples: [
      'cancelar pedido anb',
      'cancelar pedido 350',
      'nao precisa mais do pedido da nissei',
    ],
    whatsapp_examples: [
      'miauby cancelar pedido anb',
      'miauby cancelar pedido da nissei',
      'miauby nao precisa mais do pedido da anb',
    ],
    missing_data_replies: [
      'Qual pedido voce quer cancelar? Ex.: cancelar pedido ANB 350.',
      'Nao achei pedido aberto com esse nome.',
    ],
    ambiguity_rules: [
      'buscar somente pedidos abertos em Aguardando chegada',
      'se houver mais de um pedido parecido, listar opcoes e pedir numero ou fornecedor/valor',
      'sempre pedir confirmacao antes de cancelar',
      'se tiver financeiro vinculado, avisar antes da confirmacao',
      'nao apagar financeiro; usar cancelamento/arquivamento logico do app Pedidos',
    ],
    response_examples: [
      'Confirma cancelar: ANB - R$ 350,00?',
      'Achei mais de um pedido parecido. Qual deseja cancelar?',
      'Pedido cancelado: ANB - R$ 350,00.',
    ],
    notes: [
      'usuario comum precisa ter permissao no modulo Pedidos',
      'execucao usa idempotencia e auditoria no app Pedidos',
    ],
    keywords: ['cancelar pedido', 'remover pedido', 'excluir pedido', 'nao precisa mais'],
  },
  {
  ...
  {
    intent: 'criar_encomenda_cotacao',
    title: 'Criar encomenda na cotacao',
    module: 'cotacao',
    tool: 'criar_encomenda_cotacao',
    risk: 'alto',
    origins: ['miauby_interno', 'miauby_whatsapp'],
    internal_requires_prefix: false,
    whatsapp_requires_prefix: true,
    internal_supports_media: false,
    whatsapp_supports_media: false,
    required_fields: ['produto', 'responsavel_identificado'],
    optional_fields: ['cliente', 'telefone', 'informacoes_extras'],
    internal_examples: [
      'encomenda losartana 50 Maria 44 4984894',
      'cliente Joao pediu amoxicilina 500mg 44998489494',
      'encomenda Bepantol',
    ],
    whatsapp_examples: [
      'miauby Maria encomenda losartana 50 44 4984894',
      'miauby reserva para Ana dipirona gotas 20ml',
    ],
    missing_data_replies: ['Qual produto devo registrar na encomenda da Maria?'],
    ambiguity_rules: [
      'produto e cliente podem aparecer em qualquer ordem',
      'telefone deve ser separado de dosagem e apresentacao',
      'cliente e telefone sao opcionais; produto e obrigatorio',
      'se um unico termo parecer nome de pessoa e nao produto, pedir somente o produto',
      'confirmar antes de gravar e nunca substituir o cliente pelo usuario que executa',
    ],
    response_examples: [
      '✅ Encomenda adicionada: Losartana 50 — Maria — 44 4984894.',
      '✅ Bepantol adicionada como Encomenda.',
    ],
    notes: [
      'usuario autenticado ou vinculado e o ator de auditoria, nao o cliente da encomenda',
      'categoria e formada por Encomenda, cliente, telefone e informacoes extras',
      'Interno e WhatsApp reutilizam o parser PHP e o mesmo endpoint idempotente da Cotacao',
    ],
    keywords: ['encomenda', 'encomendar', 'encomendou', 'pediu', 'pediram', 'reserva para', 'separa para'],
  },
  {
