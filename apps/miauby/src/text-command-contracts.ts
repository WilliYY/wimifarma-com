...
const textCommandContracts: TextCommandContract[] = [
  ...
  },
  {
    ...
    ambiguity_rules: [
      ...
      'mais de uma tarefa parecida pede escolha curta por numero, ordinal ou trecho do titulo',
      'uma tarefa clara pede confirmacao antes de concluir',
    ],
    response_examples: ['Achei mais de uma. Qual delas? 1. Trocar todos os distribuidores', 'Confirma concluir: "Trocar todos os distribuidores"?', 'Tarefa concluida: Trocar todos os distribuidores.'],
  ...
  },
  {
    ...
    ambiguity_rules: [
      ...
      'mais de uma tarefa parecida pede escolha curta antes de confirmar',
