...
- Em 2026-05-27, o VPS oficial do Miauby WhatsApp pode operar com `MIAUW_WHATSAPP_REQUIRE_PREFIX=false` para remetentes em allowlist: perguntas soltas vao ao roteador/Gemini quando simples, consultas internas continuam indo ao core e escritas fortes seguem bloqueadas; o prefixo `miauby` continua aceito como opcional quando digitado.
