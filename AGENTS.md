...
- Pedidos controla fornecedores, chegada, vencimento de boleto, pagamentos parciais/totais, edicao auditada e historico em duas tabelas operacionais: `pedidos_orders` para pedidos registrados/aguardando chegada e `pedidos_confirmed_orders` para confirmados e historico. Na criacao, a previsao de chegada e digitada como numero de dias e gravada como data calculada em `expected_arrival_at`.
