...
- Em 2026-05-27, o VPS oficial do Miauby WhatsApp passou a operar com `MIAUW_WHATSAPP_REQUIRE_PREFIX=false` para remetentes em allowlist: mensagens sem a palavra `miauby` vao somente ao Gemini com personalidade/instrucoes seguras; mensagens com `miauby` em qualquer posicao acionam o core Miauby/API com tools e guardrails; escritas fortes seguem dependentes de confirmacao/auditoria do core, nunca de texto solto do Gemini.
