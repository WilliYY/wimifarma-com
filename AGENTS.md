...
- Em 2026-05-31, o asset comum da trilha do XP (`site/xp/assets/bloco-xp.svg`) foi otimizado de exportacao SVG com imagem base64 para SVG vetorial puro, mantendo o mesmo arquivo/rota e cache-bust atualizado em `apps/xp/src/server.ts`; nao voltar a usar exportacao base64 pesada sem medir antes/depois.
