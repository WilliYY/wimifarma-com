...
- A tela de Códigos foi dividida em duas tabelas lado a lado por prefixo de EAN, `EAN 20` e `EAN 40`, cada uma com linha nova no rodape para adicionar itens sem misturar os grupos; o layout usa largura ampla para aproveitar melhor as laterais da tela.
