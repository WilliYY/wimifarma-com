...
- Na Cotacao V2, durante a edicao de uma celula, `Enter` salva e desce exatamente uma linha; as setas ficam para mover o cursor dentro do texto editado. Duplo clique e `F2` devem abrir edicao sem selecionar todo o conteudo da celula.
