...
- Em 2026-05-25, a tela de Pedidos ficou mais densa visualmente: cards-resumo do topo usam altura menor e os cards minimizados de `Aguardando chegada`/`Confirmados` reduzem padding, chips, botoes e icones para caber mais pedidos por tela; a acao principal fica em botao curto alinhado a direita, nao em barra larga. Em 2026-05-26, o topo tambem passou a mostrar `Valor boletos abertos`, somando o saldo ainda nao pago dos boletos confirmados em aberto.
