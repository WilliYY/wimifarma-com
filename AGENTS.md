...
- Em 2026-05-25, a tela de Pedidos ficou mais densa visualmente: cards-resumo do topo usam altura menor e os cards minimizados de `Aguardando chegada`/`Confirmados` reduzem padding, chips, botoes e icones para caber mais pedidos por tela mantendo a acao principal visivel.
