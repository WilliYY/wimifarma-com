...
O `POST /miauw/agent-context.php` sem token deve responder 401 ou 503; com token interno, ele entrega contexto compartilhado para o bridge e nao deve ser testado colando segredo em comandos versionados.
