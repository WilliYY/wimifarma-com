...
- O Financeiro Node/Postgres registra auditoria oficial em `financeiro_audit_events`. Desde 2026-05-30 nao existe mais espelho runtime para `financeiro_auditoria` no MySQL; esse historico fica apenas como referencia/backup.
