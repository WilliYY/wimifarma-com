...
| --- | --- | --- | --- | --- |
| Cotacao | Node.js + Express + Postgres/Redis + core auth | sem dependencia MySQL no app | TypeScript em fases; Fase 2 contratos TS sem troca de runtime | moderno |
...
1.1. Cotacao deve migrar para TypeScript em fases pequenas: Fase 1 ja adicionou tooling/typecheck sem mudar runtime e Fase 2 ja criou contratos TS para dominio, APIs, sessao, env e Socket.IO; proximas fases devem extrair helpers pequenos, preservando frontend e Socket.IO.
