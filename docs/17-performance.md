...
- Em 2026-06-08, a Home foi restaurada para `logo-wimifarma-home-animated.gif`, que e a animacao original aprovada pelo usuario. A tentativa de trocar para SVG recriado foi retirada do fluxo porque mudava o movimento visual. Manter preload `image/gif`, cache-bust em `site/home.php`, proporcao real `1560/622` e sem `mix-blend-mode`; a validacao deve conferir login central, rodape e header autenticado em desktop/mobile.
