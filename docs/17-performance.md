...
- Em 2026-06-08, essa variacao animada da Home foi trocada para `logo-wimifarma-home-animated.svg`, com remocao da camada branca no asset versionado e cache-bust em `site/home.php`; a validacao deve conferir login central, rodape e header autenticado em desktop/mobile.
