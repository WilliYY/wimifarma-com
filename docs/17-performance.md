...
- Em 2026-06-08, a Home consolidou `logo-wimifarma-home-animated.svg` como variacao animada correta: fundo transparente, sinal `+` girando antes de formar a marca completa e proporcao `1024/400`. Manter preload `image/svg+xml`, cache-bust em `site/home.php` e sem `mix-blend-mode`; a validacao deve conferir login central, rodape e header autenticado em desktop/mobile.
