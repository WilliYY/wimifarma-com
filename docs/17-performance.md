...
- Em 2026-06-09, a Home passou a usar `logo-wimifarma-home-animated.svg` como SVG vetorial puro em loop, mantendo fundo transparente, proporcao `1024/400`, preload `image/svg+xml`, cache-bust em `site/home.php` e sem `mix-blend-mode`; nao usar PNG embutido com fundo recortado nessa logo. A validacao deve conferir login central, rodape e header autenticado em desktop/mobile.
