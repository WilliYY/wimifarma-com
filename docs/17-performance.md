...
- Em 2026-06-01, a animacao de troca de cor do footer liquido do login foi desativada em `site/home.php`. Depois, para eliminar a piscada remanescente no Chrome, o filtro SVG liquido foi removido, as bolhas cairam para 64 elementos e passaram a animar por `transform`/`opacity` em vez de tamanho/posicao; o fundo ciano, o desenho liquido do topo, formulario, video e fluxo de login foram preservados.
