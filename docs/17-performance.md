...
- Em 2026-06-09, a Home passou a usar o SVG animado em loop enviado pelo usuario em `logo-wimifarma-home-animated.svg`, mantendo fundo transparente, proporcao `1024/400`, preload `image/svg+xml`, cache-bust em `site/home.php` e sem `mix-blend-mode`; a validacao deve conferir login central, rodape e header autenticado em desktop/mobile.
