...
- Desde 2026-07-25, tokens, cookies, heartbeat, claim e fila da antiga Wimi Impressora nao sao aceitos: as rotas respondem `410`, dispositivos ativos perdem o token e trabalhos incompletos sao cancelados. As tabelas e os eventos antigos permanecem para auditoria. A impressao local usa apenas o comprovante protegido autorizado na sessao e nao recebe comandos remotos.
...
- O XP usa somente o vinculo servidor-side `core_user_xp_links`, SQL parametrizado e chave idempotente `delivery_creation + delivery_id`; o navegador nao envia pontos, funcionario XP, origem nem identidade do lancamento.
