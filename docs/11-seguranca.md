...
- O Miauby WhatsApp deve bloquear no bridge dado sensivel antes de chamar Gemini/core. Escrita forte sem `miauby` continua bloqueada localmente; com `miauby`, o pedido pode ir ao core apenas para virar tool auditada/`confirmation_required`, sem gravacao direta pelo WhatsApp.
