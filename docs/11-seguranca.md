...
- Audio transcrito segue exatamente os mesmos guardrails de texto: sem `miauby` fica em conversa simples/Gemini, com `miauby` pode acionar core/tools conforme permissao, e escrita forte exige pendencia/confirmacao. Nao aceitar audio como atalho para burlar prefixo, allowlist, card liberado ou confirmacao.
