...
- O Miauby WhatsApp deve bloquear no bridge qualquer pedido de escrita forte ou dado sensivel antes de chamar Gemini/core; consultas internas podem ir ao core somente como rota de leitura, e mensagens simples podem receber resposta local/cache curto.
