...
- O painel Usuarios permite gerar/mostrar/copiar uma nova senha apenas no navegador antes de salvar, mas nao persiste nem exibe senha em texto depois do envio. `core_users.password_hash` continua sendo a unica representacao persistida.
