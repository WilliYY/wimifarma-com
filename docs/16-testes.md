...
- Audio do Miauby WhatsApp: `apps/miauw-whatsapp/src/activation-prefix.test.ts` cobre o prefixo exato e as transcricoes foneticas reais `Miau bi`/`Miau bis`, repeticao do nome, rejeicao de `miau` isolado e preservacao da regra de texto.
