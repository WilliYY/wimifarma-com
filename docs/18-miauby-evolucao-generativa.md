...
- em 2026-06-03, a Home autenticada passou a pedir falas curtas e ocasionais do widget global perto do botao flutuante. O `site/home.php` informa apenas `data-miauw-home-greeting`, nome exibido e chave curta de sessao; `site/miauw/widget.js` usa uma lista ampla de frases rotativas, evita repetir a ultima frase por usuario em `localStorage`, usa primeiro nome quando o nome exibido e longo, guarda agenda em `sessionStorage` por usuario/sessao para respeitar refresh rapido, agenda novas falas entre 45 e 120 segundos e pausa por alguns minutos quando a pessoa interage com o widget. O disparo e exclusivo da Home; outros modulos carregam o widget sem saudacao automatica porque nao emitem esses atributos.
