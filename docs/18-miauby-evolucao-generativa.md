...
- em 2026-06-02, a Home autenticada passou a pedir uma saudacao curta do widget global perto do botao flutuante. O `site/home.php` informa apenas `data-miauw-home-greeting`, nome exibido e chave curta de sessao; `site/miauw/widget.js` usa frases rotativas, evita repetir a ultima frase por `localStorage` e usa `sessionStorage` para nao reaparecer a cada refresh. O disparo e exclusivo da Home; outros modulos carregam o widget sem saudacao automatica porque nao emitem esses atributos.
