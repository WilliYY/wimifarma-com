...
- A logo oficial da marca fica versionada como SVG horizontal nos assets compartilhados dos modulos; a atualizacao de 2026-05-21 usa os mesmos nomes de arquivo para preservar rotas e cache controlado. A home publica usa uma variacao animada propria em `assets/img/logo-wimifarma-home-animated.gif`, sem substituir os SVGs dos modulos internos.
