...
- A Fase 19 do Miauby adiciona audio Realtime/WebRTC no chat com botao explicito. O PHP cria a chamada de audio no servidor para nao expor chave ao navegador; o audio nao e persistido e voz nao executa escrita operacional direta.
