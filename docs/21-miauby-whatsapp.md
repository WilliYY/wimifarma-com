...
Em 2026-05-26, o template foi fixado em `evoapicloud/evolution-api:v2.3.6` para uma nova tentativa de pareamento, depois de a `v2.3.7` retornar `401 Unauthorized` e `Invalid buffer` nas instancias de teste.
