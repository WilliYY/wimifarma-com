...
Desde 2026-06-05, campos opcionais de rastreio do comprovante Pix, como `transaction_id`, `end_to_end_id` e chave Pix do destino, nao bloqueiam a leitura quando valor, pagador e destino Wimifarma ja foram confirmados; se esses IDs existirem, continuam sendo salvos no diagnostico sanitizado e usados para dedupe.
