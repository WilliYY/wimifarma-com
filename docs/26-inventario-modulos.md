...
- Desde 2026-06-24, o filtro por cor e calculado por celula na coluna filtrada e usa a cor final renderizada, com normalizacao entre `hex`/`rgb`, precedencia de regra condicional e estilo manual, cor-base da coluna e destaque de menor preco. `PRODUTO`, `CATEGORIA` e distribuidoras aceitam uma ou mais cores; aplicar ou limpar o filtro apenas redesenha a grade local e nao executa POST/PATCH, nao grava no Postgres e nao altera o filtro de outra sessao.
