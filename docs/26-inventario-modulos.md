...
- Em `/cashback/dashboard.php#busca`, o Balcao lista os ultimos clientes alterados por `updated_at`/`created_at`, mostra 5 por padrao e revela mais em blocos de 5 pelo botao `Mostrar mais`, sem alterar saldo, compra ou resgate.
