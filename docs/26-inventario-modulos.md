...
- Em `/cashback/relatorio.php`, `Configuracao e Relatorio` usa layout compacto com atalhos internos, cards menores, lista de atendentes em grade sem rolagem interna e microanimacoes CSS; os POSTs de manutencao/atendentes, CSRF e exportacoes CSV seguem os mesmos.
