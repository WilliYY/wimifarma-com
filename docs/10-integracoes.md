...
- A rotina n8n `financeiro-fechamento-caixa-18h` chama o bridge WhatsApp todo dia as 18h; o bridge consulta `GET /financeiro/api/internal/cash-closing-status` e so envia lembrete para contatos reais com card `Financeiro` quando o caixa do dia ainda nao estiver fechado.
