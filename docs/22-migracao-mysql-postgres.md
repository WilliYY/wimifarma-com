...
- Estado atual da Gestao: usa `core_users` como login unico, preservando a regra de permissao `adm`/`admin`/`gerente`; rollback MySQL exige restaurar commit/imagem anterior e backup/importacao validada.
