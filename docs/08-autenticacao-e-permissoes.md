...
- O painel Usuarios nao recupera nem exibe senhas atuais em texto, porque o core guarda apenas hash. O administrador pode definir uma nova senha, gerar uma senha forte no navegador, mostrar/ocultar o campo e copiar antes de salvar; depois de salva, somente o hash permanece no banco.
