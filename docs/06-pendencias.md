...
- A evolucao generativa ja possui painel de revisao, evals locais ampliados da Fase 6, registry de tools, traces estruturados, confirmacao para acoes fortes e contrato da proxima camada Node/TypeScript/Agents SDK. Ainda falta ampliar os cenarios com casos reais da operacao, edicao controlada de memorias/padroes e, se justificar, migrar streaming real para servico dedicado.
