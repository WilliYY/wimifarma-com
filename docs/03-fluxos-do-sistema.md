...
- manter a Fase 6/7 com evals locais para dados obrigatorios, schemas de tools, nao inventar dados, confirmacao de escrita forte e servico sombra validado antes do corte;
