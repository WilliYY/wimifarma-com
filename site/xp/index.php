...
<head>
    ...
    <link rel="stylesheet" href="/xp/styles.css?v=20260522h">
            ...
            <?php foreach ($employees as $employee) : ?>
                ...
                <article class="xp-employee-card" data-xp-employee-card="<?php echo e((string) $employee['id']); ?>" data-xp-employee-level="<?php echo e((string) $progress['level']); ?>">
                    <div class="xp-employee-main">
                        ...
                        <div class="xp-liquid-bar" style="--xp-fill: <?php echo e((string) $progress['percent']); ?>%; --xp-fill-px: <?php echo e($progressFillPx); ?>px;">
