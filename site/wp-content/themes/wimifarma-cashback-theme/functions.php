...
add_action(
    ...
    static function () {
        ...
        wp_enqueue_style('wfwc-miauw-widget', wfwc_home_url('/miauw/widget.css'), array(), '20260517f');
        wp_enqueue_script('wfwc-theme-script', $theme_uri . '/assets/js/theme.js', array(), $script_version, true);
        wp_enqueue_script('wfwc-miauw-widget', wfwc_home_url('/miauw/widget.js'), array(), '20260517f', true);
