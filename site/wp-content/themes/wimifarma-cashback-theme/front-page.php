...
<main class="site-main">
    <section class="wfwc-home-launchpad">
        <video class="wfwc-home-video" autoplay muted loop playsinline preload="metadata" aria-hidden="true">
            <source src="<?php echo esc_url(get_template_directory_uri() . '/assets/video/looping.mp4'); ?>" type="video/mp4">
        </video>
        <img class="wfwc-home-runner wfwc-nyan-runner" src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/nyan.gif'); ?>" alt="" aria-hidden="true" data-wfwc-runner data-runner-kind="nyan" data-miauby-screen-object="gato voador" data-miauby-screen-label="gato voador de arco-iris na home">
        <img class="wfwc-home-runner wfwc-duck-runner" src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/pato.gif'); ?>" alt="" aria-hidden="true" data-wfwc-runner data-runner-kind="duck" data-miauby-screen-object="pato" data-miauby-screen-label="pato fiscal zanzando na home">
        <img class="wfwc-home-runner wfwc-dragon-runner" src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/toothless.gif'); ?>" alt="" aria-hidden="true" data-wfwc-runner data-runner-kind="dragon" data-miauby-screen-object="dragao" data-miauby-screen-label="dragao Toothless patrulhando a home">
        <div class="wfwc-theme-shell">
            ...
            <div class="wfwc-module-grid" aria-label="Sistemas Wimifarma">
                <article class="wfwc-module-card" data-module-card="cashback">
                    ...
                    <a class="wfwc-home-btn is-secondary" href="<?php echo esc_url(home_url('/cashback/')); ?>">Entrar</a>
                </article>

                <article class="wfwc-module-card" data-module-card="cotacao">
                    <h2>Cotacao</h2>
                    <p>Area reservada para pesquisa por EAN, produto e fornecedor.</p>
                    <a class="wfwc-home-btn is-secondary" href="<?php echo esc_url(home_url('/cotacao/')); ?>">Entrar</a>
                </article>

                <article class="wfwc-module-card" data-module-card="financeiro">
                    <h2>Financeiro</h2>
                    <p>Fechamento de caixa, sangrias, maquininhas e PIX.</p>
                    <a class="wfwc-home-btn is-secondary" href="<?php echo esc_url(home_url('/financeiro/')); ?>">Entrar</a>
                </article>
                ...
                <article class="wfwc-module-card" data-module-card="tarefa">
                    ...
                    <a class="wfwc-home-btn is-secondary" href="<?php echo esc_url(home_url('/tarefa/')); ?>">Entrar</a>
                </article>
                ...
                <article class="wfwc-module-card" data-module-card="miauby">
                    ...
                    <a class="wfwc-home-btn is-secondary" href="<?php echo esc_url(home_url('/miauw/')); ?>">Entrar</a>
                </article>
            </div>
        </div>
    </section>
