...
function miauw_agent_text_command_catalog(): array
{
    return array(
        ...
        array(
            ...
            'internal_examples' => array('criar tarefa conferir caixa', 'tarefa pra mim organizar balcao', 'me lembra de conferir vencidos', 'tarefa para sueli conferir pendencia do caixa', 'tarefa para thiago conferir pedidos amanha 15h', 'me lembra de conferir vencidos sexta cedo', 'tarefa geral limpar balcao'),
            'whatsapp_examples' => array('miauby criar tarefa conferir caixa', 'miauby tarefa pra mim organizar balcao', 'miauby tarefa para sueli conferir pendencia do caixa', 'miauby tarefa para thiago conferir pedidos amanha 15h', 'miauby me lembra de conferir vencidos sexta cedo', 'miauby tarefa geral limpar balcao'),
